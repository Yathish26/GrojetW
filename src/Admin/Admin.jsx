...
import { Package, Plus, List, LogOut, User, Store } from 'lucide-react';
            ...
            <div className="bg-white p-8  shadow-md border border-gray-100 w-full max-w-md">
                ...
                <div className="space-y-3">
                    <button
                        ...
                        className="w-full flex items-center cursor-pointer justify-center gap-2 bg-green-600 text-white py-3 px-4  hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors shadow-sm"
                    >
                        <Plus size={18} />
                    ...
                    <button
                        ...
                        className="w-full flex items-center cursor-pointer justify-center gap-2 bg-white text-gray-700 py-3 px-4  border border-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors shadow-sm"
                    >
                        <List size={18} />
                        View Full Inventory
                    </button>
